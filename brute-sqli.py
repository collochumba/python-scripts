# a python scrip to brute force for admininstrator password in portswigger blind-sqli injection condition based
import requests
letters = ['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v',
           'w','x','y','z','1','2','3','4','5','6','7','8','9','0']
url = 'https://0a6e000904486b2a81462ab300b0006a.web-security-academy.net/filter?category=Gifts'#variable should contain the URL of the vulnerable web page.
cookie = 'Gp5PZUfB1Jio2aeF'#cokie from the burpsuite tool
